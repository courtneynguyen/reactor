...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsListItem = __webpack_require__(160);
	...
	var App = (function (_Component) {
		...
		_createClass(App, [{
			key: 'initializeSnippets',
			value: function initializeSnippets(num) {
				var snippetList = [];
				for (var x = 0; x < num; x++) {
					var snippet = {
						title: "Courtney"
					...
					snippet.x = x * 150;
					snippetList.push(_react2['default'].createElement(_componentsListItem2['default'], { model: snippet }));
				}
				return snippetList;
			}
		}, {
	...
	var ListItem = (function (_Component) {
	   ...
	   _createClass(ListItem, [{
	      ...
	      value: function render() {
	         ...
	         return _react2['default'].createElement(
	            'div',
	            { className: 'ListItem', style: this.divStyle },
